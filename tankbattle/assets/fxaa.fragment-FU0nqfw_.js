import{rt as e}from"./tank-model-DEYcadDW.js";var t=`fxaaPixelShader`,n=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
...
gl_FragColor=TEXTUREFUNC(textureSampler,posM,0.0);
#endif
}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as fxaaPixelShader};