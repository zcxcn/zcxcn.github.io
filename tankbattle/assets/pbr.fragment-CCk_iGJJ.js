import{rt as e}from"./tank-model-BQuKZfCq.js";import{n as t,t as ee}from"./clipPlaneFragment-DCgOc_iZ.js";import{n as te,t as ne}from"./fogFragment-57_6-jMb.js";import{n as re,t as ie}from"./meshUboDeclaration-VxeN5WLA.js";import{_ as ae,a as oe,c as se,d as ce,f as le,g as ue,h as de,i as fe,l as pe,m as me,n as he,o as ge,p as _e,r as ve,s as ye,t as be,u as xe}from"./oitFragment-B_sHrHjQ.js";import{n as Se,t as Ce}from"./logDepthDeclaration-CGtbg_FA.js";import{t as we}from"./helperFunctions-BaF_chlc.js";import{n as Te,t as Ee}from"./imageProcessingFunctions-BP5xbCbW.js";import{n as De,r as Oe,t as ke}from"./pbrBRDFFunctions-DFrZbqhR.js";var n=`pbrFragmentExtraDeclaration`,Ae=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=Ae);var je={name:n,shader:Ae},r=`samplerFragmentAlternateDeclaration`,i=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);var Me={name:r,shader:i},a=`pbrFragmentReflectionDeclaration`,o=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=o);var Ne={name:a,shader:o},s=`pbrFragmentSamplersDeclaration`,Pe=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=Pe);var Fe={name:s,shader:Pe},c=`subSurfaceScatteringFunctions`,l=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=l);var Ie={name:c,shader:l},u=`importanceSampling`,d=`fn hemisphereCosSample(u: vec2f)->vec3f {var phi: f32=2.*PI*u.x;var cosTheta2: f32=1.-u.y;var cosTheta: f32=sqrt(cosTheta2);var sinTheta: f32=sqrt(1.-cosTheta2);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
var phi: f32=2.*PI*u.x;var sinTheta: f32=pow(u.y,a/(2.*a+1.));var cosTheta: f32=sqrt(1.-sinTheta*sinTheta);return vec3f(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=d);var Le={name:u,shader:d},f=`pbrHelperFunctions`,Re=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=Re);var ze={name:f,shader:Re},p=`pbrDirectLightingSetupFunctions`,Be=`struct preLightingInfo
{lightOffset: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Be);var Ve={name:p,shader:Be},m=`pbrDirectLightingFalloffFunctions`,He=`fn computeDistanceLightFalloff_Standard(lightOffset: vec3f,range: f32)->f32
...
#endif
}`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=He);var Ue={name:m,shader:He},h=`hdrFilteringFunctions`,g=`#ifdef NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var We={name:h,shader:g},_=`pbrBlockReflectance0`,v=`var reflectanceF0: f32=reflectivityOut.reflectanceF0;var specularEnvironmentR0: vec3f=reflectivityOut.colorReflectanceF0;var specularEnvironmentR90: vec3f= reflectivityOut.reflectanceF90;
#ifdef ALPHAFRESNEL
...
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var Ge={name:_,shader:v},y=`pbrClusteredLightingFunctions`,b=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var Ke={name:y,shader:b},x=`pbrDirectLightingFunctions`,qe=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=qe);var Je={name:x,shader:qe},S=`pbrIBLFunctions`,Ye=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=Ye);var Xe={name:S,shader:Ye},C=`pbrBlockAlbedoOpacity`,Ze=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=Ze);var Qe={name:C,shader:Ze},w=`pbrBlockReflectivity`,$e=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
diffuseRoughness: f32,
reflectanceF0: f32,
...
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=$e);var et={name:w,shader:$e},T=`pbrBlockAmbientOcclusion`,tt=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=tt);var nt={name:T,shader:tt},E=`pbrBlockAlphaFresnel`,rt=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=rt);var it={name:E,shader:rt},D=`pbrBlockAnisotropic`,at=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=at);var ot={name:D,shader:at},O=`pbrBlockReflection`,k=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[O]||(e.IncludesShadersStoreWGSL[O]=k);var st={name:O,shader:k},A=`pbrBlockSheen`,j=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=j);var ct={name:A,shader:j},M=`pbrBlockClearcoat`,N=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[M]||(e.IncludesShadersStoreWGSL[M]=N);var lt={name:M,shader:N},P=`pbrBlockIridescence`,F=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[P]||(e.IncludesShadersStoreWGSL[P]=F);var ut={name:P,shader:F},I=`pbrBlockSubSurface`,L=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=L);var dt={name:I,shader:L},R=`pbrBlockNormalGeometric`,z=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=z);var ft={name:R,shader:z},B=`pbrBlockNormalFinal`,V=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[B]||(e.IncludesShadersStoreWGSL[B]=V);var pt={name:B,shader:V},H=`pbrBlockLightmapInit`,mt=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[H]||(e.IncludesShadersStoreWGSL[H]=mt);var ht={name:H,shader:mt},U=`pbrBlockGeometryInfo`,gt=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=gt);var _t={name:U,shader:gt},W=`pbrBlockReflectance`,vt=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[W]||(e.IncludesShadersStoreWGSL[W]=vt);var yt={name:W,shader:vt},G=`pbrBlockDirectLighting`,bt=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=bt);var xt={name:G,shader:bt},K=`pbrBlockFinalLitComponents`,St=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=St);var Ct={name:K,shader:St},q=`pbrBlockFinalUnlitComponents`,wt=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=wt);var Tt={name:q,shader:wt},J=`pbrBlockFinalColorComposition`,Et=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Et);var Dt={name:J,shader:Et},Y=`pbrBlockImageProcessing`,X=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[Y]||(e.IncludesShadersStoreWGSL[Y]=X);var Ot={name:Y,shader:X},Z=`pbrBlockPrePass`,kt=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[Z]||(e.IncludesShadersStoreWGSL[Z]=kt);var At={name:Z,shader:kt},Q=`pbrDebug`,jt=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Q]||(e.IncludesShadersStoreWGSL[Q]=jt);var Mt={name:Q,shader:jt},$=`pbrPixelShader`,Nt=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[$]||(e.ShadersStoreWGSL[$]=Nt);var Pt=[ae,ue,re,ie,Oe,Se,je,de,ce,Me,Ne,Fe,Te,t,Ce,te,pe,we,Ie,Le,ze,Ee,le,De,me,Ve,Ue,ke,We,_e,Ge,Ke,Je,Xe,se,ye,xe,oe,Qe,et,nt,it,ot,st,ct,lt,ut,dt,ee,ft,ge,pt,fe,ht,_t,yt,xt,ve,Ct,Tt,Dt,he,ne,Ot,At,be,Mt];for(let t of Pt)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);var Ft={name:$,shader:Nt};export{Ft as pbrPixelShaderWGSL};