import{X as e}from"./tank-model-D01qItvU.js";var t=`glowBlurPostProcessPixelShader`,n=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
