import{rt as e}from"./tank-model-BQuKZfCq.js";import{n as t,t as ee}from"./clipPlaneFragment-CgQlTwzX.js";import{n as te,t as ne}from"./fogFragment-pEa8B-ap.js";import{_ as re,a as ie,c as ae,d as oe,f as se,g as ce,h as le,i as ue,l as de,m as fe,n as pe,o as me,p as he,r as ge,s as _e,t as ve,u as ye,v as be,y as xe}from"./oitFragment-CONPVJVu.js";import{n as Se,t as Ce}from"./meshUboDeclaration-0_mielqU.js";import{n as we,t as Te}from"./logDepthDeclaration-CRLC8hZW.js";import{t as Ee}from"./helperFunctions-C42Iyd85.js";import{n as De,t as Oe}from"./imageProcessingFunctions-DdHlFboI.js";import{n as ke,r as Ae,t as je}from"./pbrBRDFFunctions-Df1iQvae.js";var n=`pbrFragmentDeclaration`,Me=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=Me);var Ne={name:n,shader:Me},r=`pbrFragmentExtraDeclaration`,Pe=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=Pe);var Fe={name:r,shader:Pe},i=`samplerFragmentAlternateDeclaration`,Ie=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=Ie);var Le={name:i,shader:Ie},a=`pbrFragmentReflectionDeclaration`,o=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var Re={name:a,shader:o},s=`pbrFragmentSamplersDeclaration`,c=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var ze={name:s,shader:c},l=`subSurfaceScatteringFunctions`,u=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var Be={name:l,shader:u},d=`importanceSampling`,f=`vec3 hemisphereCosSample(vec2 u) {float phi=2.*PI*u.x;float cosTheta2=1.-u.y;float cosTheta=sqrt(cosTheta2);float sinTheta=sqrt(1.-cosTheta2);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}
...
float phi=2.*PI*u.x;float sinTheta=pow(u.y,a/(2.*a+1.));float cosTheta=sqrt(1.-sinTheta*sinTheta);return vec3(sinTheta*cos(phi),sinTheta*sin(phi),cosTheta);}`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=f);var Ve={name:d,shader:f},p=`pbrHelperFunctions`,m=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=m);var He={name:p,shader:m},h=`pbrDirectLightingSetupFunctions`,g=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var Ue={name:h,shader:g},_=`pbrDirectLightingFalloffFunctions`,v=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[_]||(e.IncludesShadersStore[_]=v);var We={name:_,shader:v},y=`hdrFilteringFunctions`,b=`#if NUM_SAMPLES
#if NUM_SAMPLES>0
...
#endif
#endif
`;e.IncludesShadersStore[y]||(e.IncludesShadersStore[y]=b);var Ge={name:y,shader:b},x=`pbrDirectLightingFunctions`,S=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var Ke={name:x,shader:S},C=`pbrIBLFunctions`,w=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=w);var qe={name:C,shader:w},T=`pbrBlockAlbedoOpacity`,E=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=E);var Je={name:T,shader:E},D=`pbrBlockReflectivity`,O=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var Ye={name:D,shader:O},k=`pbrBlockAmbientOcclusion`,A=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var Xe={name:k,shader:A},j=`pbrBlockAlphaFresnel`,M=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var Ze={name:j,shader:M},N=`pbrBlockAnisotropic`,Qe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=Qe);var $e={name:N,shader:Qe},P=`pbrBlockReflection`,et=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[P]||(e.IncludesShadersStore[P]=et);var tt={name:P,shader:et},F=`pbrBlockSheen`,nt=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=nt);var rt={name:F,shader:nt},I=`pbrBlockClearcoat`,it=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=it);var at={name:I,shader:it},L=`pbrBlockIridescence`,ot=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=ot);var st={name:L,shader:ot},R=`pbrBlockSubSurface`,ct=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=ct);var lt={name:R,shader:ct},z=`pbrBlockReflectance0`,ut=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=ut);var dt={name:z,shader:ut},B=`pbrClusteredLightingFunctions`,ft=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[B]||(e.IncludesShadersStore[B]=ft);var pt={name:B,shader:ft},V=`pbrBlockNormalGeometric`,mt=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=mt);var ht={name:V,shader:mt},H=`pbrBlockNormalFinal`,gt=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[H]||(e.IncludesShadersStore[H]=gt);var _t={name:H,shader:gt},U=`pbrBlockLightmapInit`,vt=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=vt);var yt={name:U,shader:vt},W=`pbrBlockGeometryInfo`,bt=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=bt);var xt={name:W,shader:bt},G=`pbrBlockReflectance`,St=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=St);var Ct={name:G,shader:St},K=`pbrBlockDirectLighting`,wt=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=wt);var Tt={name:K,shader:wt},q=`pbrBlockFinalLitComponents`,Et=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=Et);var Dt={name:q,shader:Et},J=`pbrBlockFinalUnlitComponents`,Ot=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[J]||(e.IncludesShadersStore[J]=Ot);var kt={name:J,shader:Ot},Y=`pbrBlockFinalColorComposition`,At=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=At);var jt={name:Y,shader:At},X=`pbrBlockImageProcessing`,Mt=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Mt);var Nt={name:X,shader:Mt},Z=`pbrBlockPrePass`,Pt=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=Pt);var Ft={name:Z,shader:Pt},Q=`pbrDebug`,It=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=It);var Lt={name:Q,shader:It},$=`pbrPixelShader`,Rt=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[$]||(e.ShadersStore[$]=Rt);var zt=[be,re,xe,Ne,Se,Ce,Ae,we,Fe,ce,le,oe,Le,Re,ze,De,t,Te,te,de,Ee,Be,Ve,He,Oe,se,ke,fe,Ue,We,je,Ge,Ke,qe,ae,_e,ye,ie,Je,Ye,Xe,Ze,$e,tt,rt,at,st,lt,he,dt,pt,ee,ht,me,_t,ue,yt,xt,Ct,Tt,ge,Dt,kt,jt,pe,ne,Nt,Ft,ve,Lt];for(let t of zt)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);var Bt={name:$,shader:Rt};export{Bt as pbrPixelShader};