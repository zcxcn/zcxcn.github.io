import{rt as e}from"./tank-model-6M8zOKd6.js";var t=`decalFragmentDeclaration`,n=`#ifdef DECAL
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=g);var _={name:h,shader:g},v=`clusteredLightingFunctions`,y=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var b={name:v,shader:y},x=`shadowsFragmentFunctions`,S=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=S);var C={name:x,shader:S},w=`samplerFragmentDeclaration`,T=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=T);var E={name:w,shader:T},D=`reflectionFunction`,O=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k={name:D,shader:O},A=`textureRepetitionFunctions`,j=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=j);var M={name:A,shader:j},N=`bumpFragmentMainFunctions`,P=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F={name:N,shader:P},I=`bumpFragmentFunctions`,L=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=L);var te={name:I,shader:L},R=`bumpFragment`,z=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=z);var B={name:R,shader:z},V=`decalFragment`,H=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U={name:V,shader:H},W=`depthPrePass`,G=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[W]||(e.IncludesShadersStore[W]=G);var K={name:W,shader:G},q=`lightFragment`,J=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=J);var Y={name:q,shader:J},X=`logDepthFragment`,Z=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=Z);var ne={name:X,shader:Z},Q=`oitFragment`,$=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[Q]||(e.IncludesShadersStore[Q]=$);var re={name:Q,shader:$};export{l as _,U as a,F as c,E as d,C as f,f as g,ee as h,K as i,M as l,_ as m,ne as n,B as o,b as p,Y as r,te as s,re as t,k as u,o as v,r as y};