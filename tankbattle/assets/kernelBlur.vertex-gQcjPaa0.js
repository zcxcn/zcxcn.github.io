import{Q as e}from"./tank-model-BJhWidxI.js";import{t}from"./kernelBlurVaryingDeclaration-D0go0EgK.js";var n=`kernelBlurVertex`,r=`vertexOutputs.sampleCoord{X}=vertexOutputs.sampleCenter+uniforms.delta*KERNEL_OFFSET{X};`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=r);var i={name:n,shader:r},a=`kernelBlurVertexShader`,o=`attribute position: vec2f;uniform delta: vec2f;varying sampleCenter: vec2f;
